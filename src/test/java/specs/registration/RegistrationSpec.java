...
public class RegistrationSpec {
    ...
    public static ResponseSpecification registrationValidationErrorResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
            .expectStatusCode(400)
            .expectBody(matchesJsonSchemaInClasspath(
                    "schemas/registration/registration_validation_error_response_schema.json"))
            .build();
}
